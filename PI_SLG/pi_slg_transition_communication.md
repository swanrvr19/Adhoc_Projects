# PI SLG Transition Communication

Hey team, I want to share an update regarding the long-term home for the PI SLG work.

Over the past couple of weeks, I’ve been asked to work with Griffiths and Tim to evaluate where this work should sit going forward. Through those conversations, the directive has been that the PI SLG work should move into Optum Advisory rather than remain within the current corporate structure under Tim.

Practically, that means the work is expected to transition back under Herschel’s organization.

For most of the team, the expectation is that you will continue supporting this work and move with it into Herschel’s org. There are a few exceptions, including myself and a small number of others, who are not expected to transition with the work long-term.
